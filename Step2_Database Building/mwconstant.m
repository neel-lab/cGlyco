classdef mwconstant
%% MWCONSTANT: Molecular weight constant
%
% Authors:  Yusen Zhou
% Date Lastly Updated: 05/20/2020
%
      properties (Constant)
             %Hexose MW constant
             HexMonoUnde=162.0528;
             HexAvgUnde = 162.1424;
             HexMonoMethyl=204.0998;
             HexAvgMethyl = 204.2230;
             HexMonoAcetyl=288.0845;
             HexAvgAcetyl = 288.2542;
             ...
             %Pentose MW constant
             PenMonoUnde=132.0423;
             PenAvgUnde = 132.1161;
             PenMonoMethyl=160.0736;
             PenAvgMethyl = 160.1699;
             PenMonoAcetyl=216.0634;
             PenAvgAcetyl =216.1907;
